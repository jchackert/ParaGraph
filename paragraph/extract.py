...
from .languages._util import _make_id, _read_text
from .languages.configs import (
    LanguageConfig,
    _C_CONFIG,
    _CPP_CONFIG,
    _CSHARP_CONFIG,
...
def extract(paths: list[Path], cache_root: Path | None = None) -> dict:
    ...
    Args:
        ...
        cache_root: explicit root for graphify-out/cache/ (overrides the
            ...
            subdirectory so the cache stays at ./paragraph-out/cache/.
    """
